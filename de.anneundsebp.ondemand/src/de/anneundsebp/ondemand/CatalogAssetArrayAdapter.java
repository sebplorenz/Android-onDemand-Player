...
public class CatalogAssetArrayAdapter extends ArrayAdapter<Object> {
	...
	// String image =
	// "http://fm4.orf.at/v2static/storyimages/site/fm4/20131040/fin_MG_7204_body_radioprogramm.jpg";

	public CatalogAssetArrayAdapter(Context context, List<Object> objects) {
...
//		ImageButton downloadButton = (ImageButton) vi
...
//			if (!((Asset) getItem(position)).livestream) {
//				downloadButton.setTag(Integer.valueOf(position));
//				downloadButton
//						.setOnClickListener((OnClickListener) getContext());
